    ...
    return (
        <section className="px-6 sm:px-10 md:px-20 lg:px-32 py-20 space-y-12">
            ...
            <div className="text-center space-y-4">
                <h1 className="text-4xl font-bold text-gray-800">Trynic</h1>
                <p className="text-lg text-gray-600">
                    Trynic는 패션 중소기업을 위한 AI 영상 생성 플랫폼으로, 누구나 모델을 선택하고
            ...
            <div className="space-y-6">
                ...
                <p className="text-gray-700 text-justify">
                    Trynic는 AI 영상 생성 기술을 활용하여 실제 모델에 옷을 입히고, 기존 영상 스타일을
