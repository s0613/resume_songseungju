...
const BIO = `
## 송승주 프로필
- AI 에이전트 빌더 · 풀스택 개발자 (Seoul, Korea)
- 인하대학교 컴퓨터공학과 졸업 (2026)
...
- 에이전트 이전에 제품을 끝까지 만들어 본 경험: Next.js · Spring Boot · Django · AWS 스택으로 기획부터 배포까지 혼자 수행. 의료·물류·뷰티·커머스 등 도메인 경험.
- 사업화 경험: 예비창업패키지 3회 선정, 해커톤 대상 등
