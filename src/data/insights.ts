...
export const articles: Article[] = [
    ...
    },
    {
        ...
        lead: "\"인스타 포스팅 만들어줘\", \"네이버 블로그 글 써줘\" 한 마디로 기획·카피·이미지·검수·발행까지 한 번에 도는 채널은 어디일까요. S-Skills 하네스의 sj-marketing은 SNS 4개 채널과 블로그 3개 채널에서 마케팅을 자동화합니다. 단, 발행 직전에는 반드시 사람이 한 번 승인합니다.",
        blocks: [
            {
                type: "cardNews",
                cards: [
                    {
                        num: "SNS",
                        title: "인스타·링크드인·스레드·X",
                        body: "카피와 이미지를 채널 톤에 맞춰 각각 생성하고, 채널 API 또는 브라우저 자동화로 발행합니다. 같은 주제라도 LinkedIn은 길게, Instagram은 후킹 위주로 분리 작성됩니다.",
                        tag: "channel API · browser automation",
                    },
                    {
                        num: "블로그",
                        title: "네이버·티스토리·브런치",
                        body: "네이버 C-Rank·DAN25 RCON·홈피드 추천까지 노리는 알고리즘별 SEO 글을 씁니다. 2,000자 이상, 헤더 이미지 필수, ALT 텍스트로 검색 가중치까지 챙깁니다.",
                        tag: "default · rcon · home-plate",
                    },
                    {
                        num: "검수",
                        title: "브랜드 가드레일 자동",
                        body: "최저가·100% 보장·업계 1위 같은 금기어와 광고법 위반을 발행 전에 자동으로 걸러냅니다. 광고 표시가 필요하면 #광고를 강제합니다.",
                        tag: "banned words · 광고법 check",
                    },
                    {
                        num: "게이트",
                        title: "휴먼 승인 필수",
                        body: "자동화의 마지막 단계는 항상 사람입니다. 미리보기와 브랜드 검수 결과를 보고 Y/S/N으로 승인해야만 실제 채널에 올라갑니다.",
                        tag: "Y / Skip / No",
                    },
                ],
            },
            {
                type: "paragraph",
                content: "마케팅을 자동화한다고 하면 보통 \"버튼 누르면 알아서 다 올라간다\"를 떠올립니다. 하지만 진짜 문제는 발행이 아니라 그 앞 단계입니다. 채널마다 톤이 다르고, 글자 수 제한이 다르고, 금기어와 광고법이 걸려 있습니다. sj-marketing이 자동화하는 건 바로 이 __기획→카피→이미지→검수__ 구간입니다. 발행은 그 결과를 사람이 한 번 확인한 뒤에 일어납니다.",
            },
            {
                type: "paragraph",
                content: "핵심은 __채널마다 다르게 쓴다__는 것입니다. 하나의 주제를 던지면 copywriter와 image-director 에이전트가 각 채널 규격에 맞춰 따로 결과물을 만듭니다. Instagram은 150~300자에 후킹 첫 줄과 해시태그 5~15개, LinkedIn은 500~1300자의 스토리와 데이터, Threads는 200~500자, X는 280자 이내. 같은 메시지를 복사해 붙여넣는 게 아니라, 채널 성격에 맞게 재작성됩니다.",
            },
            { type: "heading", content: "SNS 4채널 — 카피와 이미지를 동시에" },
            {
                type: "paragraph",
                content: "Instagram·LinkedIn·Threads·X(Twitter)는 8단계 캠페인 플로우로 돕니다. 환경 점검 → 브랜드 프로필 확인 → 캠페인 설정 → 카피·이미지 생성 → 미리보기 → __휴먼 게이트__ → 발행 → 슬롯 저장. 주제는 한 줄만 입력하면 되고, 나머지는 에이전트가 채웁니다. 카드뉴스 시리즈가 필요하면 `--cadence=series-3`, 텍스트 스레드는 `--cadence=thread`, 특정 채널만 노리려면 `--channels=linkedin,threads`로 좁힙니다.",
            },
            {
                type: "paragraph",
                content: "실제 채널에 올리기 전에 확인만 하고 싶다면 `--dry-run`이 있습니다. 카피와 이미지, 브랜드 검수 결과까지 전부 생성하되 발행은 하지 않습니다. __자동화를 신뢰하기 전에 결과물부터 눈으로 확인__할 수 있는 안전장치입니다.",
            },
            { type: "heading", content: "블로그 3채널 — 알고리즘을 겨냥한 SEO" },
            {
                type: "harnessRefs",
                refs: [
                    {
                        name: "네이버 블로그 — 알고리즘 분기",
                        desc: "default(C-Rank·D.I.A.+), rcon(DAN25 최신 RCON), home-plate(홈피드 추천) 세 가지 전략 중 목표에 맞는 알고리즘을 선택합니다. 2,000자 이상 본문에 진정성·시의성·감성 제목을 각각 다르게 설계합니다.",
                        tag: "default · rcon · home-plate",
                    },
                    {
                        name: "티스토리 — 구글 SEO 병행",
                        desc: "네이버와 구글 검색을 동시에 노리는 채널. 헤더 이미지와 본문 이미지에 ALT 텍스트를 필수로 넣어 검색 가중치를 확보하고, 표·구조화된 본문으로 체류 시간을 끌어올립니다.",
                        tag: "ALT 필수 · 구조화 본문",
                    },
                    {
                        name: "브런치 — 에디토리얼 톤",
                        desc: "검색보다 읽는 경험이 중요한 채널. 같은 주제라도 광고 배너 없이 글의 흐름과 문장 완성도를 우선하는 에디토리얼 카피로 전환됩니다.",
                        tag: "에세이 · 가독성 우선",
                    },
                ],
            },
            {
                type: "paragraph",
                content: "블로그 콘텐츠는 단순히 글자 수만 채우지 않습니다. 기술적 SEO(색인 등록, Search Console·네이버 서치어드바이저 제출)는 별도의 sj-seo 스킬로 라우팅되고, sj-marketing은 __콘텐츠 SEO__에 집중합니다. 상위 노출을 만드는 건 결국 알고리즘이 좋아하는 구조와 진정성 있는 본문이기 때문입니다.",
            },
            { type: "heading", content: "왜 발행만큼은 자동화하지 않나" },
            {
                type: "paragraph",
                content: "마케팅 자동화에서 가장 위험한 지점은 발행입니다. 금기어 하나, 광고법 위반 하나가 브랜드 신뢰를 무너뜨립니다. 그래서 sj-marketing의 6단계는 항상 __휴먼 게이트__입니다. 미리보기와 브랜드 검수 결과(금기어·과장 표현·광고 표시 여부)를 보여주고, 사람이 Y(승인)·S(건너뛰기)·N(거부)을 입력해야만 다음으로 넘어갑니다. 자동화는 사람의 판단을 대체하는 게 아니라, __판단할 거리를 깔끔하게 차려주는 것__입니다.",
            },
            {
                type: "paragraph",
            ...
            {
                type: "cta",
                text: "\"오늘 인스타랑 블로그에 신제품 올려줘\" — 한 마디면 4개 SNS와 3개 블로그 채널 카피가 동시에 준비됩니다. __발행 직전 한 번만 승인하면 끝.__",
                btnText: "S-SKILLS 시작하기 →",
                btnHref: "/s-skills",
            },
        ],
