...
export const posts: BlogPost[] = [
    {
        ...
        blocks: [
            ...
            },
            {
                ...
                note: "마크다운 415개 · ZIP 883KB · 옵시디언에서 바로 열립니다",
            },
            {
                type: "paragraph",
                content:
            ...
            },
            {
                ...
                items: [
                    ...
                    { label: "02_기획", href: "/knowledge/zip/02_기획.zip", note: "130개 · 237KB" },
                    { label: "03_설계", href: "/knowledge/zip/03_설계.zip", note: "25개 · 73KB" },
                    { label: "04_디자인", href: "/knowledge/zip/04_디자인.zip", note: "37개 · 117KB" },
                    { label: "05_프론트엔드", href: "/knowledge/zip/05_프론트엔드.zip", note: "8개 · 20KB" },
                    { label: "06_백엔드", href: "/knowledge/zip/06_백엔드.zip", note: "8개 · 22KB" },
                    { label: "07_데이터", href: "/knowledge/zip/07_데이터.zip", note: "7개 · 20KB" },
                    { label: "08_인프라", href: "/knowledge/zip/08_인프라.zip", note: "48개 · 90KB" },
                    { label: "09_QA", href: "/knowledge/zip/09_QA.zip", note: "6개 · 15KB" },
                    { label: "10_보안", href: "/knowledge/zip/10_보안.zip", note: "5개 · 12KB" },
                    { label: "11_마케팅", href: "/knowledge/zip/11_마케팅.zip", note: "3개 · 7KB" },
                    { label: "12_커뮤니케이션", href: "/knowledge/zip/12_커뮤니케이션.zip", note: "4개 · 10KB" },
                ],
            },
            {
                type: "heading",
