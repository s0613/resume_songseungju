...
export const posts: BlogPost[] = [
    {
        slug: "redefining-london-system-purpose",
        category: "개발",
        title: "런던 시스템, 어디에 쓰는 제품인지 다시 정했습니다",
        date: "2026. 8. 5.",
        excerpt:
            "자연어로 에이전트를 만들어 운영까지 잇는 범용 AI Agent CAD에서, 사내 플랫폼에 올리기 전 그래프를 먼저 설계·검증하고 LangGraph 코드로 넘기는 도구로 목적을 좁혔습니다. 기능보다 쓰이는 순간을 다시 정한 기록입니다.",
        tags: ["LondonSystem", "AI에이전트", "LangGraph", "개인프로젝트", "제품기획"],
        blocks: [
            {
                type: "paragraph",
                content:
            ...
            },
            {
                type: "paragraph",
                content:
                    "그런데 요즘 제품을 설명할 때마다 한 문장에서 자꾸 막혔어요. __그래서 이걸 누가, 어떤 순간에 꼭 쓰는 건데?__ 할 수 있는 일을 길게 설명하는 건 쉬운데, 꺼내 쓰는 순간을 짧게 말하기가 어려웠습니다. 이건 기능 문제가 아니라 목적 문제였습니다.",
            },
            {
                type: "quote",
                content: "그래서 이걸 언제 쓰는데?",
                author: "목적을 다시 정하게 만든 질문",
            },
            { type: "heading", content: "처음에는 끝까지 다 하려고 했습니다" },
            {
                type: "paragraph",
                content:
                    "[지난 6월](/blog/starting-london-system-agent)에는 런던 시스템을 __자연어 요구사항을 운영 가능한 에이전트로 컴파일하는 AI Agent CAD__라고 소개했습니다. 요구사항을 그래프로 바꾸고, 시뮬레이션과 eval을 거쳐 API나 코드로 내보내는 제품이었어요. 틀린 설명은 아니었습니다. 실제로 그 흐름은 지금도 돌아갑니다.",
            },
            {
                type: "paragraph",
                content:
                    "다만 너무 멀리까지 한 번에 말했습니다. 자연어 빌더, 그래프 스튜디오, 실행, 비용, 정책, 배포를 전부 같은 무게로 들고 가다 보니 제품은 계속 커지는데 왜 꼭 필요한지는 오히려 흐려지더라고요. __다 할 수 있다는 말은, 아직 어디에서 제일 잘 쓰이는지 못 정했다는 말이기도 했습니다.__",
            },
            {
                type: "heading",
                content: "사내 플랫폼이 있어도 첫 그래프는 저절로 안 나옵니다",
            },
            {
                type: "paragraph",
                content:
            ...
            },
            {
                type: "paragraph",
                content:
                    "제가 London System에 맡기고 싶은 일은 바로 그 앞부분입니다. __사내 플랫폼에 들어가기 전에 그래프를 먼저 만들고, 직접 돌려 보고, 실패할 지점을 확인하는 것.__",
            },
            { type: "heading", content: "그래서 가운데 한 구간만 맡기로 했습니다" },
            {
                type: "paragraph",
                content:
            ...
            },
            {
                type: "list",
                items: [
                    "__요구사항 입력__ — 만들려는 에이전트와 그래프 범위를 자연어로 적습니다.",
                    "__그래프 설계__ — 전체 또는 일부를 만들고 구조를 눈으로 확인합니다.",
                    "__사전 검증__ — 실행·eval·비용·정책 검사로 문제를 먼저 찾습니다.",
                    "__LangGraph export__ — 읽고 고칠 수 있는 코드로 내려받습니다.",
                    "__사내 플랫폼으로 이식__ — 조직의 로직과 규칙을 붙인 뒤 내부 환경에 배포합니다.",
                ],
            },
            {
                type: "image",
                src: "/london-system-purpose-bridge.webp",
                alt: "요구사항 메모가 에이전트 그래프 설계판과 검증 단계를 거쳐 코드 묶음으로 바뀌고 다리를 건너 사내 플랫폼 그래프로 이어지는 3D 일러스트",
                width: 1717,
                height: 916,
                caption:
            ...
            },
            {
                type: "paragraph",
                content:
                    "그래서 핵심 결과물도 달라졌습니다. \"에이전트 하나 만들었습니다\"에서 끝나면 안 됩니다. __수정 가능한 LangGraph 코드와 eval·회귀 케이스, 런당 비용과 정책 검사 결과가 같이 나와야 합니다.__ 개발자가 안심하고 가져가서 자기 환경에 맞게 완성할 수 있어야 하니까요.",
            },
            {
                type: "paragraph",
                content:
            ...
            { type: "heading", content: "안 하는 일을 정하니 오히려 선명해졌습니다" },
            {
                type: "paragraph",
                content:
            ...
            },
            {
                type: "paragraph",
                content:
                    "대신 그 앞에서 아이디어를 구조로 바꾸고, 실제로 돌려 보고, 문제가 생길 만한 곳을 먼저 잡고, 고칠 수 있는 코드로 넘깁니다. __운영 플랫폼이 아니라 설계·검증 브리지__라고 정리하니 기존 기능의 우선순위도 훨씬 또렷해졌습니다.",
            },
            {
                type: "heading",
                content: "쓰는 사람과 먼저 돈 내는 사람은 다를 수 있습니다",
            },
            {
                type: "paragraph",
                content:
            ...
            },
            {
                type: "paragraph",
                content:
                    "후자는 고객마다 품질과 비용을 증명해야 하고, 검증한 코드를 고객 환경으로 넘기는 일을 반복하니 돈을 낼 이유가 더 빨리 생길 수 있습니다. 하지만 이건 어디까지나 __첫 판매 경로에 대한 가설__입니다. London System의 사용 목적을 에이전시용 운영 도구로 다시 바꾼 것은 아닙니다. 누가 쓰는지와 누가 먼저 사는지는 따로 검증하려고 합니다.",
            },
            {
                type: "tip",
                title: "헷갈리지 않으려고 나눈 것",
                content:
                    "사용 목적은 사내 플랫폼 전 단계의 그래프 설계·검증·코드 이식이고, 첫 판매 대상은 그 일을 여러 고객에게 반복하는 AI Delivery 팀일 수 있다는 가설입니다.",
            },
            { type: "heading", content: "기능은 버리지 않고, 판단 기준을 바꿨습니다" },
            {
                type: "paragraph",
                content:
                    "기존의 compile → simulate → eval → policy gate → deploy/export 흐름은 그대로 필요합니다. 다만 이제 새 기능을 볼 때 \"에이전트를 끝까지 대신 운영해 주는가\"보다 __\"개발자가 가져가 직접 완성할 만한 출발점을 만드는가\"__를 먼저 묻게 됩니다.",
            },
            {
                type: "paragraph",
                content:
            ...
            { type: "heading", content: "아직 정한 것뿐입니다" },
            {
                type: "paragraph",
                content:
            ...
            { type: "heading", content: "이제야 이름값을 하는 것 같습니다" },
            {
                type: "paragraph",
                content:
            ...
            },
            {
                type: "paragraph",
                content:
                    "돌이켜 보면 저는 한동안 운영 환경 전체를 다 가지려고 했습니다. 이번에는 판 전체를 차지하려는 대신, 운영에 들어가기 전 가장 불안한 구간을 단단하게 만드는 쪽을 골랐습니다. __기능을 줄인 게 아니라, London System을 꺼내야 하는 순간을 정한 겁니다.__ 범위를 줄였다고 꿈이 작아진 건 아닙니다. 이제 첫 수가 조금 분명해졌습니다.",
            },
            {
                type: "tip",
                title: "한 줄 요약",
                content:
                    "London System은 범용 AI 에이전트 빌더가 아니라, 사내 플랫폼에 올릴 그래프를 먼저 설계·실행·검증하고 커스터마이즈 가능한 LangGraph 코드로 넘기는 개발 전 단계의 브리지로 목적을 좁혔습니다.",
            },
        ],
    },
    {
