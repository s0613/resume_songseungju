...
const Experience: React.FC = () => {
  return (
    <section id="experience" className="py-5 px-32 pt-20">
      <div className="flex flex-col space-y-8">
        {/* EXPERIENCE & PROJECT 제목 */}
        <div>
          <h1 className="text-4xl mb-4 text-left text-blue-600">EXPERIENCE &amp; PROJECT</h1>
        </div>
        ...
        <div className="px-10">
          <div className="grid grid-cols-4 gap-4 items-center">
            <div className="col-span-1">
              <span className="text-2xl text-gray-500">2024.02 ~ 2025.12</span>
            </div>
          ...
          <div className="mt-4 ml-[25%]">
            ...
            <ul className="list-disc list-inside text-sm text-gray-800 mt-2 space-y-2">
              <li>
                생성형 AI기반 한국어 교육 서비스 <strong>동반</strong> 기획 및 백엔드 개발
              </li>
              <li>
        ...
        <div className="px-10">
          <div className="grid grid-cols-4 gap-4 items-center">
            <div className="col-span-1">
              <span className="text-2xl text-gray-500">2025.01 ~ 2025.02</span>
            </div>
            <div className="col-span-3">
              <span className="text-2xl text-black font-bold">
                최적 진입 시간 웹사이트{" "}
          ...
          {/* 역할 및 활동 내용 */}
          <div className="mt-4 ml-[25%]">
            <h3 className="text-xl font-semibold text-gray-700">풀스택 개발자</h3>
            <ul className="list-disc list-inside text-sm text-gray-800 mt-2 space-y-2">
              <li>Django와 Next.js를 활용한 외주 프로젝트 기획 및 개발</li>
              <li>최적 진입 시간 분석을 통한 사용자 경험 개선 및 웹사이트 최적화</li>
        ...
        <div className="px-10">
          <div className="grid grid-cols-4 gap-4 items-center">
            <div className="col-span-1">
              <span className="text-2xl text-gray-500">2025.01 ~</span>
            </div>
            <div className="col-span-3">
              <span className="text-2xl text-black font-bold">
                RealFeel{" "}
          ...
          <div className="mt-4 ml-[25%]">
            ...
            <ul className="list-disc list-inside text-sm text-gray-800 mt-2 space-y-2">
              ...
              <li>
                회원가입 &amp; 로그인, 이미지 업로드, 검색 기능을 중점적으로 구현하여 
                사용자 경험 최적화
              </li>
            </ul>
            <div className="mt-4 flex flex-wrap gap-2">
